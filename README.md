...
1. Describe component state.
  object that tells how a component renders
1. Describe props.
  props are properties data that can be pass to other components

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
  is a change in state or props that modify an external variable or obj property 
